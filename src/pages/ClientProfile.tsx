        ...
        >
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div><Label>家族病史</Label><Input value={form.familyHistory || ''} onChange={e => update('familyHistory', e.target.value)} placeholder="遺傳疾病..." className="bg-slate-50 border-transparent focus:bg-white focus:border-purple-200 rounded-2xl" /></div>
